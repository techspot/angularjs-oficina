angular.module('oficina').service('providersAPIService', function($http){	
	this.listAll = function(){
		
		console.log('Access Providers API Service');
	
		$providersCollection = [
			{ 
				id: 1, 
				provider_name: "Rodrigo Alves", 
				birthday: "25/05", 
